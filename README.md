...
`3.0.23` 候选加入 Kick、YouTube 公开直播与弹幕，并修复 Twitch 分区漏主播的问题。支持范围与测试记录见[接入说明](docs/GLOBAL_PLATFORMS_AUDIT.md)。

`3.0.24` Mac 测试候选增加斗鱼官方网页登录，无需手动复制 Cookie；取流时按平台实际返回的画质显示。登录不保证原画权限，实测与构建进度见[斗鱼帧率排查](docs/DOUYU_FPS_AND_COOKIE_2026_09_26.md)。
